                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Ajouter une actualite</h1>
                            </div>
                            ...
                            <form class="user" method="POST" action="{{route('actualites.store')}}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="tab-content tab-content-perso">
                                    ...
                                    <div class="tab-pane fade show active" id="p1">
                                        <div class="form-group row">
                                            <div class="col-sm-9 mb-3 mb-sm-0">
                                                <input type="text" class="form-control form-control-user" name="titre" id="exampleFirstName" placeholder="Titre" value="{{old('titre')}}" required>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12 mb-3 mb-sm-0">
                                                <input type="checkbox" class="checkbox" name="visible"> Rendre visible sur le front office ?
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="p2">
                                        <div class="form-group row">
                                            <div class="col-sm-12 mb-3 mb-sm-0">
                                                <textarea class="text" name="contenu" > {{old('contenu')}}</textarea>
                                    ...
                                    <div class="tab-pane fade tab-content-perso" id="p3">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12 mb-3 mb-sm-0">
                                                <textarea class="text" name="source">{{old('source')}}</textarea>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-9 mb-3 mb-sm-0">
                                                <input type="text" class="form-control form-control-user" name="lien" id="exampleFirstName" placeholder="Lien vers la source" value="{{old('lien')}}" required>
