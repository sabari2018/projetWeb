                    ...
                    <div class="col-lg-9">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Ajouter un conseil de sante</h1>
                            </div>

                            <form class="user" method="POST" action="{{route('conseils.store')}}">
                            {{ csrf_field() }}
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        ...
                                        <input type="text" class="form-control form-control-user" name="lien" placeholder="Lien">
                                    </div>
                                </div>
